...
<div align="center">
  <h2>🚀 About Me</h2>
  <p>
أشارك في تطوير وإدارة مشروع Heypers، الذي يهدف إلى إنشاء مجتمعات فريدة وتمكين التفاعل البشري من خلال التقنيات الجديدة. تتراوح خبرتي الفنية من التطبيقات القياسية والحاويات إلى إدارة علاقات العملاء والنمذجة ثلاثية الأبعاد.
  </p>
</div>
