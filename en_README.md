...
>then suddenly it becomes useful

- I write things that **should have been small**
- I break Minecraft and put it back together
- doing web + Discord
- sometimes I go into 3D and don’t come back
...
- I love it when there’s no shame in opening the code six months later
- strange stacks = normal solutions
- if you can simplify it, you should simplify it
- if you can’t, well, in short, let’s pretend it’s possible
...
you copy → lawyers come → then bugs appear in the code themselves.
  </p>
</details>
