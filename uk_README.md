...
<div align="center">
  <h2>🚀 About Me</h2>
  <p>
Я беру участь у розробці та управлінні проектом Heypers, метою якого є створення унікальних спільнот і забезпечення взаємодії людей за допомогою нових технологій. Мій технічний досвід варіюється від стандартних програм і контейнеризації до CRM і 3D-моделювання.
  </p>
</div>
