...
- [Особистий сайт] (https://mrf0rtuna4.github.io/)
...
- **Опис**: Мультипроектне комбінування управління, управління, помірності та розвитку.
- **Tech**: Python, Java, Docker, Django, Django Rest Framework, GLSL, CI/CD, Blender, Yaml, Linux.



### 2. Кайабот
🔗 [VEB-SATE] (kaya.heypers.org)
-**Опис**: Розбрат на дисенік за допомогою багатомовної підтримки та локалізації JSON.
...
🔗 [github.com/mrf0rtuna4/git-markdown-autotranslatorsensemple 7ttps://github.com/mrf0rtuna4/git-markdown-autotranslator)
